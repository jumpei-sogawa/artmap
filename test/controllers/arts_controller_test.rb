...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { artist_id: @art.artist_id, image_url: @art.image_url, location_url: @art.location_url, title: @art.title, view_url: @art.view_url, year: @art.year } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { artist_id: @art.artist_id, image_url: @art.image_url, location_url: @art.location_url, title: @art.title, view_url: @art.view_url, year: @art.year } }
